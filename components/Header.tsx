...
function Header() {
  ...
  return (
    <header>
        <form onSubmit={handleSearch} className="flex justify-center item-center py-2 px-4 bg rounded-full bg-indigo-100 max-w-md mx-auto ">
            <input ref={inputRef} type="text" placeholder="Searching for items if u want" className="flex-1 outline-none bg-transparent text-indigo-400 placeholder:text-indigo-300"/>
